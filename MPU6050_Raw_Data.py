...
file_name = str("MPURawData_0.csv")
...
if __name__ == "__main__":
    while 1:
	    ...
	    GZ = gyro_data['z']
            ...
            print("Ti:{:.4f}\tAx:{:.4f}\tAy:{:.4f}\tAz:{:.4f}\tGx:{:.4f}\tGy:{:.4f}\tGz:{:.4f} ".format(time.time() - now, accel_data['x'], accel_data['y'], accel_data['z'], gyro_data['x'], gyro_data['y'], gyro_data['z']))
	  
	    f.write("{:.4f},{:.4f},{:.4f},{:.4f},{:.4f},{:.4f},{:.4f}".format(instant_time,AX,AY,AZ,GX,GY,GZ))
	    f.write("\r\n")
	  
	    AX=AY=AZ=GX=GY=GZ=instant_time=0
